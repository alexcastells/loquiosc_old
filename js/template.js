(function($) { "use strict";
	...
	jQuery(document).ready(function(){
		var e=new google.maps.LatLng(42.184917,0.917902),
			o={zoom:14,center:new google.maps.LatLng(42.184917,0.917902),
			...
			var g='<div class="map-tooltip"><h6>Lo quiosc</h6><p>On els somnis es fan realitat</p></div>',a=new google.maps.InfoWindow({content:g})
			...
			i=new google.maps.LatLng(42.184917,0.917902),
